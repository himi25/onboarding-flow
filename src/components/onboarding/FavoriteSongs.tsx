    ...
    return (
        <div>
            <div className="mb-6">
                ...
                <p className="mt-1 text-sm text-slate-500">What music moves you? Add your favorites</p>
            </div>
                            ...
                            {({ push, remove }) => (
                                <div className="space-y-3">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => push('')}
                                        className="flex items-center gap-2 w-full p-3 text-sm font-medium text-indigo-600 bg-indigo-50/50 hover:bg-indigo-50 border border-dashed border-indigo-200 rounded-xl transition-all duration-200 hover:border-indigo-300"
                                    >
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
